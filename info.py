...
API_ID = environ.get('API_ID', '22672907')
if len(API_ID) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '6287591671')
if len(ADMINS) == 0:
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://rani828719:sVyRWZOrUzIWNfHp@cluster0.zodktob.mongodb.net/?retryWrites=true&w=majority")
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002016613151")
if len(BIN_CHANNEL) == 0:
    logging.error('BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://t.me/+5oY1g38A8tM1N2Zl")
if len(URL) == 0:
